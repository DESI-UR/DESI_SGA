...
latex_filename = 'iron_TF_pv_short-v19.tex'
...
colhead = '\\tablehead{\\colhead{SGA-2020} & \\colhead{R.A.} & \\colhead{Decl.} & \\colhead{Redshift} & \\colhead{$D(26)$} & \\colhead{$m_r(26)$} & \\colhead{$V(0.4R_{26})$} & \\colhead{$\mu$} & \\colhead{$\eta$} & \\colhead{Main} & \\colhead{Morphology} \\\[-0.5em] \\colhead{ID} & \\colhead{[deg]} & \\colhead{[deg]} & & \colhead{[arcmin]} & \colhead{[AB mag]} & \\colhead{[km/s]} & \\colhead{[AB mag]} & & \\colhead{sample} & }'
